...
// phone auth
  ...
  var NIDA_no_phone_no = {
  	"7382537xxxxx": "915801xxxx",
  	"987654321934": "0776663804",
	"987654321987": "0783390074",
  }
  ...
  function onSignInSubmit() {
    ...
    $('#errorbox').hide();
   // updateSignInButtonUI();
    var phoneNumber = "+255" + NIDA_no_phone_no[$('#NIDA_no').val()];
    //console.log(phoneNumber);
      var d = new Date();
      d.setTime(d.getTime() + (1*24*60*60*1000));      
      var expires = "expires="+ d.toUTCString();
      document.cookie = 'NIDA' + "=" + $('#NIDA_no').val() + ";" + expires + ";path=/";
...
$(getotp).click(function(){
	if ($('#NIDA_no').val()=="") {
		$('#errorbox').show()
		$('#error').text('Please Enter NIDA number')
